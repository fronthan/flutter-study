        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              ...
              spreadRadius: 2.0,//퍼짐 정도 double값
            ),
          ],
        ),
        child: Padding(padding: EdgeInsets.all(16.0),
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: 12.0),
              Text('LIVE', style: TextStyle(color: Colors.white, fontSize: 30.0, letterSpacing: 4.0)),
            ],
          ),
        ),
      )
...
class _Image extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(child:
      Image.asset('asset/img/home_img.png'),
    );
  }
}
...
class _EntryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ElevatedButton(
          onPressed: () {//MaterialApp으로 최상위를 감싸주면 Navigator를 앱 어디서든 사용할 수 있다.
