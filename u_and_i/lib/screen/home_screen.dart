...
class _DDay extends StatelessWidget {
  ...
  //GestureTapCallback은 마테리얼 패키지에서 기본 제공 Typedef
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: 16.0),
        IconButton(iconSize:60.0, onPressed: onHeartPressed,
...
class _CoupleImage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Expanded(//오버플로 영역이 생겨서 보완
      child: Center(
        child: Image.asset(
          'assets/img/middle_image.png',
          height: MediaQuery.of(context).size.height / 2, //화면의 반만큼 이지만, expanded 위젯이 우선시되어 무시된다.
        ),    
      ),
    );
  }
